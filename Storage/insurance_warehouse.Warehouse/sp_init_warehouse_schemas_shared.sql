CREATE OR ALTER PROCEDURE meta.sp_init_warehouse_schemas
AS
BEGIN
    -- ==========================================================================================
    ...
    SELECT
        ...
        DATEADD(DAY, 1 - DAY(d), d) AS month_start_date,
