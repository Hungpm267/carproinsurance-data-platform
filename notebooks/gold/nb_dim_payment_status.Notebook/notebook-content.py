...
TARGET_TABLE = f"{gold_schema}.dim_payment_status"
SK_COL = "payment_status_key"
NAME_COL = "payment_status_name"
SOURCE_COL = "payment_status"
...
new_rows_sk.select(SK_COL, NAME_COL).createOrReplaceTempView("src_dim_payment_status")
...
# MAGIC %%sql
# MAGIC 
# MAGIC MERGE INTO gold.dim_payment_status AS tgt
# MAGIC USING src_dim_payment_status AS src
# MAGIC ON tgt.payment_status_name = src.payment_status_name
# MAGIC WHEN MATCHED THEN UPDATE SET
# MAGIC     tgt.payment_status_name = src.payment_status_name
# MAGIC WHEN NOT MATCHED THEN INSERT (payment_status_key, payment_status_name)
# MAGIC VALUES (src.payment_status_key, src.payment_status_name);
