...
TARGET_TABLE = f"{gold_schema}.dim_quotation_status"
SK_COL = "quotation_status_key"
NAME_COL = "quotation_status_name"
SOURCE_COL = "quotation_status"
...
new_rows_sk.select(SK_COL, NAME_COL).createOrReplaceTempView("src_dim_quotation_status")
...
# MAGIC %%sql
# MAGIC  
# MAGIC MERGE INTO gold.dim_quotation_status AS tgt
# MAGIC USING src_dim_quotation_status AS src
# MAGIC ON tgt.quotation_status_name = src.quotation_status_name
# MAGIC WHEN MATCHED THEN UPDATE SET
# MAGIC     tgt.quotation_status_name = src.quotation_status_name
# MAGIC WHEN NOT MATCHED THEN INSERT (quotation_status_key, quotation_status_name)
# MAGIC VALUES (src.quotation_status_key, src.quotation_status_name);
